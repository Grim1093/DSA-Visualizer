...
export default function DataStructuresTestingPage() {
  ...
  const rawChallenges = getChallengesByCategory('data-structures');
      ...
      <div className="p-6 pb-24 relative z-10 max-w-5xl mx-auto">
        ...
        <div className="mb-12 flex justify-between items-end border-b border-outline-variant pb-6 pt-4 gap-4">
            <div className="flex flex-col gap-4">
              <h2 className="font-headline-lg text-headline-lg text-primary tracking-tighter uppercase">DATA STRUCTURE CHALLENGES</h2>
            </div>
